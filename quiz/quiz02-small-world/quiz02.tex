...
Point a camera at the square, or type \formshort\ --- keep your working and
your labels readable.}
\end{minipage}
\end{tcolorbox}
...
\textbf{(a) [3 pts]} This definition is broken. Say what is wrong with it, and
back your answer with a concrete case --- two networks that $S$ ranks the wrong
way round, or a network with a large $S$ that no one would call a small world.

\vspace{0.2em}

\textbf{(b) [1 pt]} Repair it. Write down a definition that does not have the
problem you named, and say in one sentence what your version compares against.
