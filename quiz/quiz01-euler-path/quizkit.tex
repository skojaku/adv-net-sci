% Shared preamble for Quiz 01 (quiz01.tex and solutions.tex).
...
% points go.skojaku.com/ans-quiz01 at the current Google Form
...
% than the printer.
% ---------------------------------------------------------------------------
\newcommand{\formlink}{https://go.skojaku.com/ans-quiz01}
\newcommand{\formshort}{\href{\formlink}{\texttt{go.skojaku.com/ans-quiz01}}}
