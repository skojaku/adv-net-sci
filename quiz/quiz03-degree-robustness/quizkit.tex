% Shared preamble for Quiz 03 (quiz03.tex and solutions.tex).
...
% points go.skojaku.com/ans-quiz03 at the current Google Form
...
%
%   uvx --from segno segno --output=quiz03-form-qr.png --scale=20 --border=1 \
%       --error=m "<the url>"
%
...
% than the printer.
% ---------------------------------------------------------------------------
\newcommand{\formlink}{https://go.skojaku.com/ans-quiz03}
\newcommand{\formshort}{\href{\formlink}{\texttt{go.skojaku.com/ans-quiz03}}}
