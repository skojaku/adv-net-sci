#!/usr/bin/env python3
"""Build the Google Form for Quiz 3 (degree bias and robustness).

The form is a drop box, not a copy of the quiz. The questions live in
`quiz03.pdf`, which the form links to; all the form does is take a photo of the
...
FORM_ID = "1ap27Cku9mpn06gwJrt84i7nRgFFs_WnB8O6puCfOero"

TITLE = "Quiz 3 — Degree bias and robustness"
DOCUMENT_TITLE = "advnetsci-quiz03-degree-robustness"

QUIZ_PDF = "https://go.skojaku.com/quiz03"

DESCRIPTION = (
    "Advanced Network Science - Fall 2026\n\n"
    "20 minutes - 10 points - Closed notes, work on your own.\n\n"
    f"The questions: {QUIZ_PDF}\n\n"
    "Write each question's answer on its own page. Photograph each page and "
    "upload it below - one photo per question. Both answers are derivations, "
    "so photograph the whole page and keep the algebra readable."
)
...
def create():
    ...
    print("go.skojaku.com/ans-quiz03 at the responder URL.")
