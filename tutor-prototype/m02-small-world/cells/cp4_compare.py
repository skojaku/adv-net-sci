...
# describe: A choice - no extra cable / short cable (2 apart) / long cable (opposite) - that redraws an 8-dot ring; the chosen cable is rust-red and the title shows the average distance.
# --- cell: cp4_choice ---
