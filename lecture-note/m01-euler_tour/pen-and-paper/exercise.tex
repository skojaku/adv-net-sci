...
{\bf Question 6(d)}: The notebook in Part 4 will square your grid for you.
...
\begin{tcolorbox}[colback=white, boxsep=1pt, top=6pt, bottom=6pt]
\begin{minipage}[c]{0.26\textwidth}
\begin{center}
\includegraphics[width=3cm]{m01lab-qr.png}
\end{center}
\end{minipage}
\hfill
