...
**[Run this notebook]({{< var molab.m05 >}})** — it runs in your browser, with
...
[`notebooks/m05-clustering/coding.py`](https://github.com/skojaku/adv-net-sci/blob/main/notebooks/m05-clustering/coding.py).
