...
## How the 10 points are given

Same score for everyone on the team.

| What | Points |
|---|---|
| The class does something, and the lesson uses what they produced | 4 |
| The topic is taught, not just described | 3 |
| The lesson runs 15 to 20 minutes and is prepared | 2 |
| The plan reached me one week before the date | 1 |

**The class does something (4).** Four points: every person in the room
produces something — a filled line on a worksheet, a number they computed, a
guess they wrote down, a move in a game — and you then use what they produced.
Two points: an activity happened, but the lesson would have been identical
without it. Zero: the class watched.

**The topic is taught (3).** Three points: we leave knowing one specific thing
we did not know, and why it is true. Two: the idea is stated correctly but
nothing is explained. One: a list of terms and papers.

**Time and preparation (2).** Two points: it fits in 15 to 20 minutes, the
materials work, and the order was planned. One point if it runs over, ends
early, or the materials fail. Zero if it is improvised on the spot.

**The plan (1).** One point if you send me the plan by the date in the
"Plan due" column of the sign-up sheet, which is one week before you teach. The
plan is short: the topic, what the class will do, and how long each part takes.
