...
{\bf Question 6(b)}: The real model never adds a friendship. It takes one away
and puts it back somewhere else: person 1 stops being friends with person 2,
and becomes friends with person 9 instead. Which friends did persons 1 and 2
have in common? So how many triangles does the town lose?
...
5 says half their pairs do --- then most of the 150 people your friend reaches
are people you were already reaching yourself. The tree above is drawn with no
two branches ever landing on the same person, and that is the part that is
false. Every step adds far fewer than 150 times as many new people, so the
tower of powers is an \ans{overestimate of the reach} and therefore an
\ans{underestimate of the number of handshakes}. Clustering is exactly what
makes six degrees hard.
