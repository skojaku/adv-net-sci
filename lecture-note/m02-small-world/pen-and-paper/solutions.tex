...
{\bf Question 7(b)}: Nobody appears in the tree twice: every branch lands on a
person the chain has not reached yet. But in Part 3 you found that your friends
are often friends with each other, so some branches must land on somebody
already in the tree. Does the real number of handshakes needed to reach eight
billion go up or down? Why?

\arrow It goes \ans{up --- more handshakes}. Half of person 3's pairs of
