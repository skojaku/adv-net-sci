...
{\bf Question 2(b)}: In each person's box, write how many handshakes it takes
to reach them from person 1.
...
{\bf Question 2(c)}: Add up every number in the boxes. Share that total out
among the fifteen other people --- the average. And the biggest number in any
box --- the worst case.
...
{\bf Question 3}: A thousand people, still one circle, still four friends each.
How many handshakes to the person sitting directly opposite? And with eight
billion? Could a world wired like Ringville deliver the Omaha letter in six?
...
Person 1 is now also friends with person 9, and person 5 with person 13.
Thirty-four friendships, not thirty-two.

{\bf Question 4}: Fill in the boxes again. New total, new average, new worst
case.

\arrow Above right. Total \ans{27}, average $27/15 = \ans{1.8}$, worst case
\ans{3}, now reached only by persons 6 and 12.

{\bf Question 5}: Friendships went up by what per cent, and the average down by
what per cent? What did those two lines do that thirty-two ordinary friendships
could not?
...
Person 3's four friends are persons 1, 2, 4 and 5, and those four make six
pairs.

{\bf Question 6(a)}: Go back to the circle on page 1 and check the six pairs.
Darken the dashed lines that are real friendships. How many of the six?
...
each. How many of the six are friends now?
...
{\bf Question 6(c)}: The same sixteen people and the same thirty-two
friendships, drawn out of a hat. What is the chance two people are friends?
How many of the six pairs would you expect? And in a hat-drawn town of ten
thousand?
...
{\bf Question 6(d)}: That fraction is person 3's \textbf{local clustering}. Say
in one sentence what makes it big and what makes it small.
...
{\bf Question 7(a)}: Do persons 1 and 9 have a friend in common? Do 5 and 13?
So how many triangles now?
...
{\bf Question 7(b)}: Person 1 drops person 2 and befriends person 9 instead.
...
{\bf Question 8(a)}: Everybody knows 150 people and no two of your friends know
each other. At how many handshakes do you pass eight billion?
...
{\bf Question 8(c)}: You are person 3, holding a letter for person 12, and you
can only see your own friends and the chairs they sit in. Write the chain the
rule produces, then the shortest chain that exists.
...
find one''? Which did the letters test?
