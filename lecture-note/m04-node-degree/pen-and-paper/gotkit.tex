...
\begin{tikzpicture}[y=1cm]
  ...
  \draw[axisline] (0,2.9) -- (12.4,2.9);
  \foreach \n in {0,4,8,12,16,20,24,28,32} {
    \draw[axisline] (\n*0.375,2.9) -- ++(0,-0.24);
    \node[tlab, below] at (\n*0.375,2.66) {\n};}
  \node[tlab, anchor=west] at (0,3.95) {\bfseries Ruler A \normalfont ---
    every step adds 4};
...
\begin{tikzpicture}[x=2.35cm, y=1.30cm]
...
\newcommand{\fivemarks}{%
  \draw[marker] (1.875,3.28) -- (1.875,2.52);
  \node[tlab, pltblue!72!black, above] at (1.875,3.28) {\bfseries 5};
