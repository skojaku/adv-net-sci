...
<!-- TODO(anim): a small network with node colors updated one GCN layer at a time; by layer 6 every node is the same color. A slider for depth, and a readout of how far apart the two most different nodes still are. -->
