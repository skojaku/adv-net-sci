  ...
  const scenes = [
    {
      ...
      short: "Nine cables, distinct prices, one cheapest tree.",
    ...
    },
    {
      ...
      short: "Price order; refuse any that closes a cycle.",
    ...
    },
    {
      ...
      short: "Grow one component by its cheapest outgoing cable.",
    ...
    },
    {
      ...
      short: "The cheapest cable across any cut must be in the tree.",
