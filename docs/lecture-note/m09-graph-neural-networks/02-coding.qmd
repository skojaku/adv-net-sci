...
# Get true community labels (0 or 1)
membership = np.array(G.vs["Faction"])

print(f"Number of nodes: {n_nodes}")
print(f"Number of edges: {G.ecount()}")
print(f"Class distribution: {np.bincount(membership)}")
```
...
print(f"Number of classes: {len(np.unique(membership))}")
```
