...
# Plot the graph (requires cairocffi or pycairo)
try:
    igraph.plot(g, bbox=(150, 150), vertex_label=list(range(4)))
except AttributeError as e:
    print("Plotting not available. Install plotting dependencies:")
    print("pip install cairocffi  # or pycairo")
    print("\nGraph structure:")
    print(f"Vertices: {g.vcount()}")
    print(f"Edges: {g.ecount()}")
    print(f"Edge list: {[(e.source, e.target) for e in g.es]}")
```
