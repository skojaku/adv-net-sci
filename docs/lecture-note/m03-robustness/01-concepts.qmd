...
A grid of puddles that are connected if they share a side. Percolation theory explains how a giant puddle forms when the probability of a puddle is large enough.

:::

::: {.callout-tip title="interactive exploration"}

Experience percolation phase transitions firsthand with this interactive visualization 🎮: [**Interactive Percolation Demo**](percolation-visualization.py)

Use the slider to control the puddle probability and watch how the giant component emerges at the critical point!
...
where $\langle k \rangle$ is the average degree and $\langle k^2 \rangle$ is the average of squared degrees. The ratio $\kappa$ measures **degree heterogeneity**, i.e., networks with hubs have high $\kappa$, while degree homogeneous networks have low $\kappa$.
