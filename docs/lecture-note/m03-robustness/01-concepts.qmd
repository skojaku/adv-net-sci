...
## The Power Grid Design Challenge: A Historical Perspective
...
Imagine you're an engineer in the early 1900s, tasked with designing an electrical grid for a growing city. You need to connect every neighborhood to the power plant, but laying electrical cables is expensive. How do you ensure everyone gets electricity while minimizing the total cost of cables?

This is more than a historical curiosity - it's a fundamental question in network design that appears everywhere: laying fiber optic cables for internet infrastructure, building transportation networks, designing communication systems, and even understanding biological networks like blood vessel systems.

The mathematical answer to this cost-minimization problem is the **minimum spanning tree (MST)** - a tree that connects all locations with the minimum total cable length. But as we'll discover, the most economical solution often creates the most fragile network.
