...
[Open the notebook in molab]({{< var molab.m06 >}})

Prefer to work locally? The same notebook is in the repository at
[`notebooks/m06-centrality/coding.ipynb`](https://github.com/skojaku/adv-net-sci/blob/main/notebooks/m06-centrality/coding.ipynb).
