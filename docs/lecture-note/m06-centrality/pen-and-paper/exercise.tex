...
\vspace{8em}
{\bf Question 4}:
How might this network change if a new Robotics Club is formed, and Noah and Emma join it? How would this affect your answers to the previous questions?

\clearpage

{\bf Question 5}: Let's consider the following network:
...
{\bf Question 8}: Going back to the school club network, which student would you approach first if you wanted to spread information quickly about a new inter-club event?

\vspace{3em}
{\bf Question 9}: Which student would you recommend to be the "Club Coordinator" to help communication between different clubs?

\vspace{3em}
{\bf Question 10}: How would the network change if a new Robotics Club is formed, and Noah and Emma join it? How would this affect your answers to the previous questions?
