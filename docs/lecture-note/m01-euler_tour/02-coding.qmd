...
[Open the notebook in molab]({{< var molab.m01 >}})

Prefer to work locally? The same notebook is in the repository at
[`notebooks/m01-euler-tour/coding.ipynb`](https://github.com/skojaku/adv-net-sci/blob/main/notebooks/m01-euler-tour/coding.ipynb).
