...
```python {.marimo}
# Display results based on question input
if question_input.value and question_input.value.strip():
    if not api_key_holder.value.strip():
        ...
        # Process the questions (this happens via on_change)
...
"""
    ...
    mo.md("**Ready to test questions.** Enter your question and answer above to get started.")
```
