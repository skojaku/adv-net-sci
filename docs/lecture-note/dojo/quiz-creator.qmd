...
def process_with_progress(raw_input):
    ...
    # Step 1: Parsing
    progress_msg = "🔄 **Step 1/4**: Parsing questions and answers..."
    
    # Get selected module and context
    ...
    for i, q in enumerate(parse_result["questions"], 1):
        ...
        # Step 3: Quiz LLM Processing
        progress_msg = f"🤖 **Step 3/4**: Question {i}/{total_questions} - AI taking quiz..."
        ...
        # Step 4: Evaluation
        progress_msg = f"⚖️ **Step 4/4**: Question {i}/{total_questions} - Evaluating answers..."
    ...
    success_text = f"✅ **Complete!** Processed {total_questions} questions. {evaluated_count} evaluated, {wins} wins."
    ...
    return mo.callout(success_text, kind="success")
...
if processing_results and processing_results["success"]:
    # Display results
    callouts = []
    results = processing_results  # Use the stored results
