...
def read_module_content(module_name: str) -> Dict[str, str]:
    ...
    standard_files = ["01-concepts", "02-coding", "03-exercises", "04-advanced"]
...
- Be concise and direct - aim for 2-3 sentences maximum
...
def send_question_to_quiz_llm(question: str, module_context: str) -> Dict[str, Any]:
    ...
    llm_response = call_llm_api(messages, model="hermes3:latest", temperature=0.1, max_tokens=200)
