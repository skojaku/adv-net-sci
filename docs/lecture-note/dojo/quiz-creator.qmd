...
```python {.marimo}
# This approach matches the Quiz Dojo pattern more closely
...
elif not question_input.value or not answer_input.value or not api_key_holder.value:
    mo.md("❌ Please fill in all required fields above.")
else:
    # Add console logging for debugging
    print("🔧 DEBUG: Test button clicked and all fields filled!")
