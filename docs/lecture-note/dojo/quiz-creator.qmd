...
## How to Play: Quiz Creator Dojo

1. **Select Module**
   Choose the course module that matches the topic of your question. This gives the LLM the right context.

2. **Enter Your Question**
   Type a question that tests understanding of a network science concept. Aim for clarity and depth—think like a teacher!

3. **Provide the Expected Answer**
   Write the correct answer you expect from a well-prepared student.

4. **Submit for Evaluation**
   The system will:
   - **Validate** your question for relevance and clarity
   - **Challenge the LLM** to answer it
   - **Evaluate** the LLM's response against your answer
   - **Give feedback** on question quality and how well it stumped the LLM

5. **Refine and Repeat**
   Use the feedback to improve your question. Try to create questions that are clear, relevant, and challenging—even for an advanced AI!

**Goal:**
Craft questions that *stump the LLM* and help you (and your classmates) think more deeply about the material. The better your questions, the sharper your skills as a quiz master!
:::
...
## 📝 Input Formats: Questions and Answers

The Quiz Creator supports multiple input formats to make it easy to enter your questions and answers. Choose the format that works best for you:

### **Format 1: Simple Question-Answer**
The most straightforward format for single questions:
...
Write questions and answers naturally:
...
### **Format 3: TOML Format (Recommended)**
Perfect for multiple questions or when you want precision:
...
### **Format 4: Q&A Style**
Simple abbreviation format:

```
Q: What is network robustness?
A: The ability of a network to maintain functionality when nodes or edges are removed.

Q: How do you measure centrality?
A: Using metrics like degree, betweenness, or eigenvector centrality.
```

### **📋 Format Guidelines**

- **Question Quality**: Make questions clear, specific, and focused on key concepts
- **Answer Completeness**: Provide comprehensive answers that demonstrate understanding
- **Multiple Questions**: Use TOML format for multiple questions in one submission
- **Special Characters**: All formats handle quotes, punctuation, and mathematical notation
- **Length**: No strict limits, but aim for clarity over length

### **💡 Pro Tips**
- Use **TOML format** for multiple questions - it's the most reliable
