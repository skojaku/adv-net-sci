...
This runs after marp and fails the build on what a student actually sees.
    ...
    marp m05-clustering.md --theme network-science.css --allow-local-files \
...
def figure_containers(deck="m05-clustering.md"):
...
def figcaption_math(deck="m05-clustering.md"):
...
def slides_with_figures(deck="m05-clustering.md"):
