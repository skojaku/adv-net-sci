...
This runs after marp and fails the build on what a student actually sees.
    ...
    marp m06-centrality.md --theme network-science.css --allow-local-files \
...
def figure_containers(deck="m06-centrality.md"):
...
def figcaption_math(deck="m06-centrality.md"):
...
def slides_with_figures(deck="m06-centrality.md"):
