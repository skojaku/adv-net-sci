...
- **Method of analysis**: break complex problems into simple parts
- Mind-body dualism: separate thinking substance from physical substance
- **Mechanical philosophy**: universe operates like a giant machine
...
## Newton: Mathematical Precision ⚖️

:::: {.columns}

::: {.column width="50%"}

**Isaac Newton** (1643-1727): *"Nature is pleased with simplicity"*

- **Universal laws**: same principles explain falling apples and planetary motion
- Mathematical equations capture all physical phenomena
- **Clockwork universe**: perfect, predictable, mechanical system

**Key insight:** Find the *universal mathematical laws* governing everything

:::

::: {.column width="50%"}

![](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Portrait_of_Sir_Isaac_Newton%2C_1689.jpg/640px-Portrait_of_Sir_Isaac_Newton%2C_1689.jpg){width=80% fig-align="center"}
...
::: {.callout-note title = "Question:"}
**Five different approaches to understanding reality:**
...
**Modern science:**
- **Descartes**: Everything is *systematic analysis* (divide and conquer)
- **Newton**: Everything is *universal laws* (mathematical precision)
