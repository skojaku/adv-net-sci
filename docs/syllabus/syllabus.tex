...
\begin{minipage}{5in}
\begin{flushleft}
Intro: Seven Bridges of Königsberg \dotfill ~ 08/21, 08/26 \\
Break it or Fix it: Network Robustness \dotfill ~ 08/28, 09/02 \\
Friendship Paradox \& Project Matchmaking \dotfill ~ 09/04, 09/09 \\
(No Class - Labor Day) \dotfill ~ 09/01 \\
Community Detection I \dotfill ~ 09/11, 09/16 \\
Community Detection II \dotfill ~ 09/18, 09/23 \\
(No Class - Rosh Hashanah) \dotfill ~ 09/24, 09/25 \\
Centrality \dotfill ~ 09/30, 10/02 \\
(Class dismisses 1pm - Yom Kippur prep) \dotfill ~ 10/01 \\
(No Class - Yom Kippur) \dotfill ~ 10/02 \\
Random walks: An intelligent drunkard \& Preferential attachment \dotfill ~ 10/07, 10/09 \\
Leveraging GPUs in your brain: Visualization \dotfill ~ 10/14, 10/16 \\
Random graphs \dotfill ~ 10/21, 10/23 \\
(No Class - Rejuvenation Day) \dotfill ~ 10/24 \\
Network compression using graph spectra \dotfill ~ 10/28, 10/30 \\
From connectivities to distance: Graph embeddings \dotfill ~ 11/04, 11/06 \\
Graph Neural Networks \dotfill ~ 11/11, 11/13 \\
Course Project Work Time \dotfill ~ 11/18, 11/20 \\
(No Class - Thanksgiving Break) \dotfill ~ 11/26, 11/27 \\
Presentation \dotfill ~ 12/02, 12/04 \\
