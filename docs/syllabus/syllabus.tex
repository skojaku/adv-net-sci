...
Small-world Networks \dotfill ~ 08/28 (Thu), 09/04 (Thu) \\
(No Class - Monday classes meet) \dotfill ~ 09/02 \\
Network Robustness \& Project Matchmaking \dotfill ~ 09/09 (Tue), 09/11 (Thu) \\
Friendship Paradox  \dotfill ~ 09/16 (Tue), 09/18 (Thu) \\
(No Class - Rosh Hashanah) \dotfill ~ 09/23 (Tue) \\
Community Detection I \dotfill ~ 09/25 (Thu), 09/30 (Tue) \\
(No class - Yom Kippur prep) \dotfill ~ 10/02 (Thu) \\
Community Detection II \dotfill ~ 10/07 (Tue), 10/09 (Thu) \\
Centrality \dotfill ~ 10/14 (Tue), 10/16 (Thu) \\
Random walks: An intelligent drunkard \& Preferential attachment \dotfill ~ 10/21 (Tue), 10/23 (Thu) \\
...
(No Class - Thanksgiving Break) \dotfill ~ 11/27 \\
