...
\textbf{Office Hour:} &  13:00 - 15:00 Friday & & & & \textbf{Zoom:} & \href{https://binghamton.zoom.us/my/skojaku.zoom}{my/skojaku.zoom}
\end{tabular}
\end{minipage}
\rule{6in}{0.4pt}
\end{center}
...
\vskip.15in
\noindent\textbf{Office Hours:} Friday 13:00 - 15:00.
...
09/01 (Tue) \dotfill Small-world Networks / MP \\
09/03 (Thu) \dotfill Network Robustness \\
09/08 (Tue) \dotfill No class (Monday classes meet) \\
09/10 (Thu) \dotfill Network Robustness \\
09/15 (Tue) \dotfill Network Robustness / MP \\
09/17 (Thu) \dotfill Friendship Paradox \\
09/22 (Tue) \dotfill Friendship Paradox \\
09/24 (Thu) \dotfill Friendship Paradox / MP \\
09/29 (Tue) \dotfill Clustering \\
...
\begin{itemize}
    \item \textbf{Sadamori Kojaku:} 13:00-15:00 Fridays at J19 Engineering Building (in person) or Zoom (\url{https://binghamton.zoom.us/my/skojaku.zoom}).
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attendance}: Residential students are strongly encouraged to attend class in person whenever possible; in-person attendance is consistently linked to stronger learning outcomes in the research literature (\url{https://journals.sagepub.com/doi/10.3102/0034654310362998}, \url{https://www.nature.com/articles/s41599-023-02590-1}, \url{https://www.educationnext.org/zooming-to-class-slows-student-learning/}). If you are not able to attend the class in person, submit the absence request form (\url{https://forms.gle/yhzHoMSaKCRJXdGm7}) and also email the instructor, ideally one day before the class. \textbf{An absence that is not submitted through the form is not counted}, even if you emailed about it. We may not accept excuses for reasons other than illness, accidents, job interviews, and conference travels. If you are not able to attend in person for more than two weeks due to illness or some other legitimate reason, please request an acceptable accommodation over email.
    ...
    We encourage you to first attempt each assignment with your own hands and your own head, before turning to AI. Many assignments in this course can be solved by an AI in seconds, but if you hand the whole problem to it, the concept or skill the assignment was designed to teach dissolves the moment you close the chat window. If you already understand the underlying concept well, you can tell what the AI is doing and use it as a genuine aid; if you do not, you are merely clearing today's task, and the same kind of problem will trip you up again later, unresolved, because the understanding never actually formed.

    Think of it like a gym. You pay good money and show up to lift weights so that your body gets stronger. If you bring a forklift and let it do the lifting, sure --- the forklift can move any weight, no matter how heavy --- but you would leave the gym exactly as weak as when you walked in. Lift with your own body first and build the muscle; only then reach for machinery to go further. Use AI the same way.

    \item \textbf{AI Resources}: If you choose to use generative AI as a learning aid, Binghamton University provides several free options:
    \begin{itemize}
        \item \textbf{Google Gemini} --- free for all students; log in with your BU Google account at \url{https://gemini.google.com}.
        \item \textbf{chat.binghamton.edu} --- a campus-hosted LLM chat service run by ITS. You can issue your own API key from the account settings and use it to power coding agents (e.g., Claude Code, Cursor, Codex) at no cost.
        \item \textbf{OpenRouter} (\url{https://openrouter.ai}) --- offers a free tier of open-weight LLMs (50 requests/day). Creating an account and adding as little as \$10 in credit permanently raises this to 1{,}000 requests/day, even after that credit is spent down --- so it is effectively a one-time investment, not an ongoing cost.
    \end{itemize}
