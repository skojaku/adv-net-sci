...
Small-world Networks \dotfill ~ 08/28 (Thu) \\
(No Class - Monday classes meet on Tue) \dotfill ~ 09/02 \\
Small-world Networks (cont'd) \dotfill ~ 09/04 (Thu) \\
...
Random walks \dotfill ~ 10/21 (Tue), 10/23 (Thu) \\
