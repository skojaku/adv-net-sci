...
\begin{minipage}{5in}
\begin{flushleft}
Intro: Seven Bridges of Königsberg \dotfill ~ 08/21 (Thu), 08/26 (Tue) \\
Small-world Networks \dotfill ~ 08/28 (Thu), 09/02 (Tue) \\
(No Class - Labor Day) \dotfill ~ 09/01 \\
Break it or Fix it: Network Robustness \dotfill ~ 09/04 (Thu), 09/09 (Tue) \\
Friendship Paradox \& Project Matchmaking \dotfill ~ 09/11 (Thu), 09/16 (Tue) \\
Community Detection I \dotfill ~ 09/18 (Thu), 09/23 (Tue) \\
(No Class - Rosh Hashanah) \dotfill ~ 09/24, 09/25 \\
Community Detection II \dotfill ~ 09/30 (Tue), 10/02 (Thu) \\
(Class dismisses 1pm - Yom Kippur prep) \dotfill ~ 10/01 \\
(No Class - Yom Kippur) \dotfill ~ 10/02 \\
Centrality \dotfill ~ 10/07 (Tue), 10/09 (Thu) \\
Random walks: An intelligent drunkard \& Preferential attachment \dotfill ~ 10/14 (Tue), 10/16 (Thu) \\
Leveraging GPUs in your brain: Visualization \dotfill ~ 10/21 (Tue), 10/23 (Thu) \\
(No Class - Rejuvenation Day) \dotfill ~ 10/24 \\
Random graphs \dotfill ~ 10/28 (Tue), 10/30 (Thu) \\
Network compression using graph spectra \dotfill ~ 11/04 (Tue), 11/06 (Thu) \\
From connectivities to distance: Graph embeddings \dotfill ~ 11/11 (Tue), 11/13 (Thu) \\
Graph Neural Networks \dotfill ~ 11/18 (Tue), 11/20 (Thu) \\
Course Project Work Time \dotfill ~ 11/25 (Tue) \\
(No Class - Thanksgiving Break) \dotfill ~ 11/26, 11/27 \\
Presentation \dotfill ~ 12/02 (Tue), 12/04 (Thu) \\
Reading Days \dotfill ~ 12/06-12/07 \\
