...
\begin{minipage}{5in}
\begin{flushleft}
Intro: Seven Bridges of Königsberg \dotfill ~ 08/21, 08/26 (Week 1) \\
Break it or Fix it: Network Robustness \dotfill ~ 08/28, 09/02 (Week 2) \\
Friendship Paradox \& Project Matchmaking \dotfill ~ 09/04, 09/09 (Week 3) \\
(No Class - Labor Day) \dotfill ~ 09/01 \\
Community Detection I \dotfill ~ 09/11, 09/16 (Week 4) \\
Community Detection II \dotfill ~ 09/18, 09/23 (Week 5) \\
(No Class - Rosh Hashanah) \dotfill ~ 09/24, 09/25 \\
Centrality \dotfill ~ 09/30, 10/02 (Week 6) \\
(Class dismisses 1pm - Yom Kippur prep) \dotfill ~ 10/01 \\
(No Class - Yom Kippur) \dotfill ~ 10/02 \\
Random walks: An intelligent drunkard \& Preferential attachment \dotfill ~ 10/07, 10/09 (Week 7) \\
Leveraging GPUs in your brain: Visualization \dotfill ~ 10/14, 10/16 (Week 8) \\
Random graphs \dotfill ~ 10/21, 10/23 (Week 9) \\
(No Class - Rejuvenation Day) \dotfill ~ 10/24 \\
Network compression using graph spectra \dotfill ~ 10/28, 10/30 (Week 10) \\
From connectivities to distance: Graph embeddings \dotfill ~ 11/04, 11/06 (Week 11) \\
Graph Neural Networks \dotfill ~ 11/11, 11/13 (Week 12) \\
Course Project Work Time \dotfill ~ 11/18, 11/20 (Week 13) \\
(No Class - Thanksgiving Break) \dotfill ~ 11/26, 11/27 \\
Presentation \dotfill ~ 12/02, 12/04 (Week 14) \\
