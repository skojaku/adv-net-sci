...
\vskip.15in
\noindent\textbf{Office Hours:} Tuesday 15:30 - 16:30. Thursday 15:30 - 16:30.
...
\begin{minipage}{5in}
\begin{flushleft}
Intro: Seven Bridges of Königsberg \dotfill ~ 08/21 (Week 1) \\
Break it or Fix it: Network Robustness \dotfill ~ 08/28 (Week 2) \\
Friendship Paradox \dotfill ~ 09/04 (Week 3) \\
Project Matchmaking \& Community Detection \dotfill ~ 09/11 (Week 4) \\
Centrality \dotfill ~ 09/18 (Week 5) \\
Random walks: An intelligent drunkard \dotfill ~ 09/25 (Week 6) \\
(No Class) \dotfill ~ 10/02 (Week 7) \\
Rich gets richer and are forgotten: Network evolution \dotfill ~ 10/09 (Week 8) \\
Leveraging GPUs in your brain: Visualization \dotfill ~ 10/16 (Week 9) \\
Random graphs \dotfill ~ 10/23 (Week 10) \\
Network compression using graph spectra \dotfill ~ 10/30 (Week 11) \\
From connectivities to distance: Graph embeddings \dotfill ~ 11/06 (Week 12) \\
Graph Neural Networks \dotfill ~ 11/13 (Week 13) \\
Course Project Work Time \dotfill ~ 11/20 (Week 14) \\
(No Class) \dotfill ~ 11/27 (Week 15) \\
Presentation \dotfill ~ 12/04 (Week 16) \\
Final exam week \dotfill ~ 12/09-12/13 (Week 17) \\
\end{flushleft}
\end{minipage}
\end{center}
...
\begin{flushleft}
Project Proposal \#1      \dotfill ~09/29 \\
Project Final Paper \#2      \dotfill ~12/04 \\
Project Presentation \#3      \dotfill ~12/08 \\
Final Exam       \dotfill ~12/09-12/13 \\
\end{flushleft}
\end{minipage}
\end{center}
