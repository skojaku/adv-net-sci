...
\begin{flushleft}
\textbf{August 2026:} \\
08/18 (Tue) \dotfill Intro: Seven Bridges of K\"onigsberg \\
08/20 (Thu) \dotfill Intro: Seven Bridges of K\"onigsberg \\
08/25 (Tue) \dotfill Small-world Networks \\
08/27 (Thu) \dotfill Small-world Networks \& Project Matchmaking\\

\textbf{September 2026:} \\
09/01 (Tue) \dotfill Network Robustness \\
09/03 (Thu) \dotfill Network Robustness \\
09/08 (Tue) \dotfill No class (Monday classes meet) \\
09/10 (Thu) \dotfill Friendship Paradox \\
09/15 (Tue) \dotfill Friendship Paradox \\
09/17 (Thu) \dotfill Community Detection I \\
09/22 (Tue) \dotfill Community Detection I \\
09/24 (Thu) \dotfill Community Detection II \\
09/29 (Tue) \dotfill Community Detection II \\

\textbf{October 2026:} \\
10/01 (Thu) \dotfill Centrality \\
10/06 (Tue) \dotfill Centrality \\
10/08 (Thu) \dotfill Random walks \\
10/13 (Tue) \dotfill No class (Fall break) \\
10/15 (Thu) \dotfill No class (Fall break) \\
10/20 (Tue) \dotfill Random walks \\
10/22 (Thu) \dotfill Random graphs \\
10/27 (Tue) \dotfill Random graphs \\
10/29 (Thu) \dotfill Network compression using graph spectra \\

\textbf{November 2026:} \\
11/03 (Tue) \dotfill Network compression using graph spectra \\
11/05 (Thu) \dotfill From connectivities to distance: Graph embeddings \\
11/10 (Tue) \dotfill From connectivities to distance: Graph embeddings \\
11/12 (Thu) \dotfill Graph Neural Networks \\
11/17 (Tue) \dotfill Graph Neural Networks \\
11/19 (Thu) \dotfill Course Project Work Time \\
11/24 (Tue) \dotfill Course Project Work Time \\
11/26 (Thu) \dotfill No class (Thanksgiving) \\

\textbf{December 2026:} \\
12/01 (Tue) \dotfill Presentation \\
...
Project Presentation \#2      \dotfill ~12/01 and 12/03 \\
